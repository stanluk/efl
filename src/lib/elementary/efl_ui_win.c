...
EOLIAN static void
_efl_ui_win_efl_gfx_stack_move_to_top(Eo *obj EINA_UNUSED, Efl_Ui_Win_Data *pd)
{
   TRAP(pd, raise);
}
...
EOLIAN static void
_efl_ui_win_efl_gfx_stack_move_to_bottom(Eo *obj, Efl_Ui_Win_Data *pd EINA_UNUSED)
{
