...
static void
_efl_canvas_vg_node_efl_gfx_stack_move_to_top(Eo *obj, Efl_Canvas_Vg_Node_Data *pd EINA_UNUSED)
{
   Efl_Canvas_Vg_Container_Data *cd;
...
static void
_efl_canvas_vg_node_efl_gfx_stack_move_to_bottom(Eo *obj, Efl_Canvas_Vg_Node_Data *pd EINA_UNUSED)
{
   Efl_Canvas_Vg_Container_Data *cd;
...
{
   efl_gfx_stack_move_to_top(obj);
}

EAPI void
evas_vg_node_lower(Eo *obj)
{
   efl_gfx_stack_move_to_bottom(obj);
}
