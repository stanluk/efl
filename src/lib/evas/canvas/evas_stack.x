...
{
   efl_gfx_stack_move_to_top((Evas_Object *)obj);
}

EOLIAN void
_efl_canvas_object_efl_gfx_stack_move_to_top(Eo *eo_obj, Evas_Object_Protected_Data *obj)
{
...
{
   efl_gfx_stack_move_to_bottom((Evas_Object *)obj);
}

EOLIAN void
_efl_canvas_object_efl_gfx_stack_move_to_bottom(Eo *eo_obj, Evas_Object_Protected_Data *obj)
{
